...
#include "Device_Cfg.h"
    ...
    #include "Z20K144M.h"
#elif (defined(DEV_Z20K148MS))
    #include "Z20K148MS.h"
#elif (defined(DEV_Z20K146MS))
    #include "Z20K146MS.h"
#elif (defined(DEV_Z20K144MS))
    #include "Z20K144MS.h"
#elif (defined(DEV_Z20K142MS))
    #include "Z20K142MS.h"
#else
...
#define DEVICE_REGS_H_SW_MAJOR_VERSION            2U
#define DEVICE_REGS_H_SW_MINOR_VERSION            0U
#define DEVICE_REGS_H_SW_PATCH_VERSION            0U
...
#ifdef DEV_Z20K148MS
    /* Check if current file and Z20K148MS.h are the same vendor */
    #if (DEVICE_REGS_H_VENDOR_ID != Z20K148MS_H_VENDOR_ID)
        #error "Vendor ID of Device_Regs.h and Z20K148MS.h are different"
    #endif

    /* Check if current file and Z20K148MS.h are the same Autosar version */
    #if ((DEVICE_REGS_H_AR_RELEASE_MAJOR_VERSION != Z20K148MS_H_AR_RELEASE_MAJOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_MINOR_VERSION != Z20K148MS_H_AR_RELEASE_MINOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_REVISION_VERSION != Z20K148MS_H_AR_RELEASE_REVISION_VERSION))
        #error "AutoSar Version of Device_Regs.h and Z20K148MS.h are different"
    #endif

    /* Check if current file and Z20K148MS.h are the same Software version */
    #if ((DEVICE_REGS_H_SW_MAJOR_VERSION != Z20K148MS_H_SW_MAJOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_MINOR_VERSION != Z20K148MS_H_SW_MINOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_PATCH_VERSION != Z20K148MS_H_SW_PATCH_VERSION))
        #error "Software Version of Device_Regs.h and Z20K148MS.h are different"
    #endif
#endif /*DEV_Z20K148MS*/

#ifdef DEV_Z20K146MS
    /* Check if current file and Z20K146MS.h are the same vendor */
    #if (DEVICE_REGS_H_VENDOR_ID != Z20K146MS_H_VENDOR_ID)
        #error "Vendor ID of Device_Regs.h and Z20K146MS.h are different"
    #endif

    /* Check if current file and Z20K146MS.h are the same Autosar version */
    #if ((DEVICE_REGS_H_AR_RELEASE_MAJOR_VERSION != Z20K146MS_H_AR_RELEASE_MAJOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_MINOR_VERSION != Z20K146MS_H_AR_RELEASE_MINOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_REVISION_VERSION != Z20K146MS_H_AR_RELEASE_REVISION_VERSION))
        #error "AutoSar Version of Device_Regs.h and Z20K146MS.h are different"
    #endif

    /* Check if current file and Z20K146MS.h are the same Software version */
    #if ((DEVICE_REGS_H_SW_MAJOR_VERSION != Z20K146MS_H_SW_MAJOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_MINOR_VERSION != Z20K146MS_H_SW_MINOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_PATCH_VERSION != Z20K146MS_H_SW_PATCH_VERSION))
        #error "Software Version of Device_Regs.h and Z20K146MS.h are different"
    #endif
#endif /*DEV_Z20K146MS*/

#ifdef DEV_Z20K144MS
    /* Check if current file and Z20K144MS.h are the same vendor */
    #if (DEVICE_REGS_H_VENDOR_ID != Z20K144MS_H_VENDOR_ID)
        #error "Vendor ID of Device_Regs.h and Z20K144MS.h are different"
    #endif

    /* Check if current file and Z20K144MS.h are the same Autosar version */
    #if ((DEVICE_REGS_H_AR_RELEASE_MAJOR_VERSION != Z20K144MS_H_AR_RELEASE_MAJOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_MINOR_VERSION != Z20K144MS_H_AR_RELEASE_MINOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_REVISION_VERSION != Z20K144MS_H_AR_RELEASE_REVISION_VERSION))
        #error "AutoSar Version of Device_Regs.h and Z20K144MS.h are different"
    #endif

    /* Check if current file and Z20K144MS.h are the same Software version */
    #if ((DEVICE_REGS_H_SW_MAJOR_VERSION != Z20K144MS_H_SW_MAJOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_MINOR_VERSION != Z20K144MS_H_SW_MINOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_PATCH_VERSION != Z20K144MS_H_SW_PATCH_VERSION))
        #error "Software Version of Device_Regs.h and Z20K144MS.h are different"
    #endif
#endif /*DEV_Z20K144MS*/

#ifdef DEV_Z20K142MS
    /* Check if current file and Z20K142MS.h are the same vendor */
    #if (DEVICE_REGS_H_VENDOR_ID != Z20K142MS_H_VENDOR_ID)
        #error "Vendor ID of Device_Regs.h and Z20K142MS.h are different"
    #endif

    /* Check if current file and Z20K142MS.h are the same Autosar version */
    #if ((DEVICE_REGS_H_AR_RELEASE_MAJOR_VERSION != Z20K142MS_H_AR_RELEASE_MAJOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_MINOR_VERSION != Z20K142MS_H_AR_RELEASE_MINOR_VERSION) ||        \
         (DEVICE_REGS_H_AR_RELEASE_REVISION_VERSION != Z20K142MS_H_AR_RELEASE_REVISION_VERSION))
        #error "AutoSar Version of Device_Regs.h and Z20K142MS.h are different"
    #endif

    /* Check if current file and Z20K142MS.h are the same Software version */
    #if ((DEVICE_REGS_H_SW_MAJOR_VERSION != Z20K142MS_H_SW_MAJOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_MINOR_VERSION != Z20K142MS_H_SW_MINOR_VERSION) ||                        \
         (DEVICE_REGS_H_SW_PATCH_VERSION != Z20K142MS_H_SW_PATCH_VERSION))
        #error "Software Version of Device_Regs.h and Z20K142MS.h are different"
    #endif
#endif /*DEV_Z20K142MS*/
