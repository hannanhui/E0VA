...
#define COMM_BUSSM_VENDOR_ID                   0U
#define COMM_BUSSM_AR_RELEASE_MAJOR_VERSION    4u
#define COMM_BUSSM_AR_RELEASE_MINOR_VERSION    2u
#define COMM_BUSSM_AR_RELEASE_REVISION_VERSION 2u
#define COMM_BUSSM_SW_MAJOR_VERSION            1u
#define COMM_BUSSM_SW_MINOR_VERSION            2u
#define COMM_BUSSM_SW_PATCH_VERSION            0U
...
#if(\
      (COMM_BUSSM_AR_RELEASE_MAJOR_VERSION != COMTYPE_AR_RELEASE_MAJOR_VERSION) || \
      (COMM_BUSSM_AR_RELEASE_MINOR_VERSION != COMTYPE_AR_RELEASE_MINOR_VERSION) \
      )
#error "AutoSar Version Number of ComM_BusSM.h and ComStack_Types.h are different "
#endif
#endif


/* Check if current file and ComM_Types.h header file are of the same vendor  */
#if(COMM_BUSSM_VENDOR_ID != COMM_TYPES_VENDOR_ID )
#error "ComM_BusSM.h and ComM_Types.h have different vendor id"
#endif

/* Check if current file and ComM_Types.h header file are of the same Autosar version  */
#if(\
      (COMM_BUSSM_AR_RELEASE_MAJOR_VERSION != COMM_TYPES_AR_RELEASE_MAJOR_VERSION) || \
      (COMM_BUSSM_AR_RELEASE_MINOR_VERSION != COMM_TYPES_AR_RELEASE_MINOR_VERSION) || \
      (COMM_BUSSM_AR_RELEASE_REVISION_VERSION != COMM_TYPES_AR_RELEASE_REVISION_VERSION) \
      )
#error "AutoSar Version Number of ComM_BusSM.h and ComM_Types.h are different "
#endif

/* Check if current file and ComM_Types.h header file are of the same software version  */
#if(\
      (COMM_BUSSM_SW_MAJOR_VERSION != COMM_TYPES_SW_MAJOR_VERSION) || \
      (COMM_BUSSM_SW_MINOR_VERSION != COMM_TYPES_SW_MINOR_VERSION) ||\
	  (COMM_BUSSM_SW_PATCH_VERSION != COMM_TYPES_SW_PATCH_VERSION)\
      )
#error "Software Version Number of ComM_BusSM.h and ComM_Types.h are different "
#endif
