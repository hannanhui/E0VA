...
#define COMM_COM_VENDOR_ID                   0U
#define COMM_COM_AR_RELEASE_MAJOR_VERSION    4u
#define COMM_COM_AR_RELEASE_MINOR_VERSION    2u
#define COMM_COM_AR_RELEASE_REVISION_VERSION 2u
#define COMM_COM_SW_MAJOR_VERSION            1u
#define COMM_COM_SW_MINOR_VERSION            2u
#define COMM_COM_SW_PATCH_VERSION            0U

/*====================================================================================================*
 *                                         FILE VERSION CHECKS
 *====================================================================================================*/
/* Check if current file and ComM_Cfg.h header file are of the same vendor  */
#if(COMM_COM_VENDOR_ID != COMM_CFG_VENDOR_ID )
#error "ComM_Com.h and ComM_Cfg.h have different vendor id"
#endif

/* Check if current file and ComM_Cfg.h header file are of the same Autosar version  */
#if(\
      (COMM_COM_AR_RELEASE_MAJOR_VERSION != COMM_CFG_AR_RELEASE_MAJOR_VERSION) || \
      (COMM_COM_AR_RELEASE_MINOR_VERSION != COMM_CFG_AR_RELEASE_MINOR_VERSION) || \
      (COMM_COM_AR_RELEASE_REVISION_VERSION != COMM_CFG_AR_RELEASE_REVISION_VERSION) \
      )
#error "AutoSar Version Number of ComM_Com.h and ComM_Cfg.h are different "
#endif

/* Check if current file and ComM_Cfg.h header file are of the same software version  */
#if(\
      (COMM_COM_SW_MAJOR_VERSION != COMM_CFG_SW_MAJOR_VERSION) || \
      (COMM_COM_SW_MINOR_VERSION != COMM_CFG_SW_MINOR_VERSION) ||\
	  (COMM_COM_SW_PATCH_VERSION != COMM_CFG_SW_PATCH_VERSION)\
      )
#error "Software Version Number of ComM_Com.h and ComM_Cfg.h are different "
#endif

#ifndef DISABLE_INTERMOD_VERSION_CHECK
/* Check if current file and Std_Types.h header file are of the same Autosar version  */
#if(\
      (COMM_COM_AR_RELEASE_MAJOR_VERSION != STD_AR_RELEASE_MAJOR_VERSION) || \
      (COMM_COM_AR_RELEASE_MINOR_VERSION != STD_AR_RELEASE_MINOR_VERSION) \
      )
#error "AutoSar Version Number of ComM_Com.h and Std_Types.h are different "
#endif
#endif
