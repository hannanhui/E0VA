...
#define COMM_DCM_VENDOR_ID                   0u
#define COMM_DCM_AR_RELEASE_MAJOR_VERSION    4u
#define COMM_DCM_AR_RELEASE_MINOR_VERSION    2u
#define COMM_DCM_AR_RELEASE_REVISION_VERSION 2u
#define COMM_DCM_SW_MAJOR_VERSION            1u
#define COMM_DCM_SW_MINOR_VERSION            2u
#define COMM_DCM_SW_PATCH_VERSION            0u

/*====================================================================================================*
 *                                         FILE VERSION CHECKS
 *====================================================================================================*/
/* Check if current file and ComM_Cfg.h header file are of the same vendor  */
#if(COMM_DCM_VENDOR_ID != COMM_CFG_VENDOR_ID )
#error "ComM_Dcm.h and ComM_Cfg.h have different vendor id"
#endif

/* Check if current file and ComM_Cfg.h header file are of the same Autosar version  */
#if(\
      (COMM_DCM_AR_RELEASE_MAJOR_VERSION != COMM_CFG_AR_RELEASE_MAJOR_VERSION) || \
      (COMM_DCM_AR_RELEASE_MINOR_VERSION != COMM_CFG_AR_RELEASE_MINOR_VERSION) || \
      (COMM_DCM_AR_RELEASE_REVISION_VERSION != COMM_CFG_AR_RELEASE_REVISION_VERSION) \
      )
#error "AutoSar Version Number of ComM_Dcm.h and ComM_Cfg.h are different "
#endif

/* Check if current file and ComM_Cfg.h header file are of the same software version  */
#if(\
      (COMM_DCM_SW_MAJOR_VERSION != COMM_CFG_SW_MAJOR_VERSION) || \
      (COMM_DCM_SW_MINOR_VERSION != COMM_CFG_SW_MINOR_VERSION) ||\
	  (COMM_DCM_SW_PATCH_VERSION != COMM_CFG_SW_PATCH_VERSION)\
      )
#error "Software Version Number of ComM_Dcm.h and ComM_Cfg.h are different "
#endif

#ifndef DISABLE_INTERMOD_VERSION_CHECK
/* Check if current file and ComStack_Types.h header file are of the same Autosar version  */
#if(\
      (COMM_DCM_AR_RELEASE_MAJOR_VERSION != COMTYPE_AR_RELEASE_MAJOR_VERSION) || \
      (COMM_DCM_AR_RELEASE_MINOR_VERSION != COMTYPE_AR_RELEASE_MINOR_VERSION) \
      )
#error "AutoSar Version Number of ComM_Dcm.h and ComStack_Types.h are different "
#endif
#endif
