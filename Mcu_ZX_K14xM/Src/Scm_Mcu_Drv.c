...
#define SCM_MCU_DRV_C_SW_MAJOR_VERSION            2U
#define SCM_MCU_DRV_C_SW_MINOR_VERSION            0U
#define SCM_MCU_DRV_C_SW_PATCH_VERSION            0U
...
#define SCM_MCU_DRV_CACHE_BE_FLAG_OFFSET ((uint32)16U)
#define SCM_MCU_DRV_CLEAR_CACHE_ERRORS   ((uint32)1U << SCM_MCU_DRV_CACHE_BE_FLAG_OFFSET)
...
void Scm_Mcu_Drv_DeInit(void)
{
    ...
    if ((IntStatus & SCM_MCU_DRV_CLEAR_CACHE_ERRORS) != 0U)
    {
