...
typedef struct{
	/**< @brief Configures if TP Frames of not requested LIN-Slaves are dropped or not.
	 *          TRUE: Drop TP Frames of not requested LIN-Slaves.
	 *          FALSE: Keep TP Frames of not requested LIN-Slaves.
	 */
	 ...
	 */
	NetworkHandleType LinTpChannelRef;
}LinTpChannelConfigType;
