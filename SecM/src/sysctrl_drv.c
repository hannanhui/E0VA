...
static ModuleRst_t * const parccRegPtrArray[] =
{
    /*PRQA S 0303 ++*/
 ...
 * @brief      Reset module.
 *
 * @param[in]  mod: Select which module to reset. The valid value is defined in enum 
 *                  SYSCTRL_Module_t. If type SYSCTRL_RSVDOx84 and SYSCTRL_RSVDOxA4 are used as 
 *                  input parameters for the function, the function will take no effect. 
 *
 * @return     none
 *
 */
 ...
 *
 * @param[in]  mod: Select which module to enable. The valid value is defined in enum 
 *                  SYSCTRL_Module_t. If type SYSCTRL_RSVDOx84 and SYSCTRL_RSVDOxA4 are used as 
 *                  input parameters for the function, the function will take no effect. 
 *
 * @return     none
 ...
 *
 * @param[in]  mod: Select which module to disable. The valid value is defined in enum 
 *                  SYSCTRL_Module_t. If type SYSCTRL_RSVDOx84 and SYSCTRL_RSVDOxA4 are used as 
 *                  input parameters for the function, the function will take no effect. 
 *
 * @return     none
 ...
 *
 * @param[in]  mod: Select which module to config. The valid value is defined in enum 
 *                  SYSCTRL_Module_t. If type SYSCTRL_RSVDOx84 and SYSCTRL_RSVDOxA4 are used as 
 *                  input parameters for the function, the function will take no effect. 
