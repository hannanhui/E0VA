...
#define WDOG_DRV_PBCFG_C_SW_MAJOR_VERSION            2U
#define WDOG_DRV_PBCFG_C_SW_MINOR_VERSION            0U
#define WDOG_DRV_PBCFG_C_SW_PATCH_VERSION            0U
...
const Wdog_Drv_ConfigType Wdog_Drv_SlowModeConfig=
{
    ...
    .TimeoutValue = (uint32)0x00007d00U,
