...
#define PORT_DRV_PBCFG_C_SW_MAJOR_VERSION            2U
#define PORT_DRV_PBCFG_C_SW_MINOR_VERSION            0U
#define PORT_DRV_PBCFG_C_SW_PATCH_VERSION            0U
