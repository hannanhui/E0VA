...
#define SCC_DRV_PBCFG_C_SW_MAJOR_VERSION            2U
#define SCC_DRV_PBCFG_C_SW_MINOR_VERSION            0U
#define SCC_DRV_PBCFG_C_SW_PATCH_VERSION            0U
...
{
    {
        /* System clock config */
        {
            ...
            (Scc_Drv_SysClockDividerType)3U,
        },
