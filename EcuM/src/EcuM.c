...
#define ECUM_SW_PATCH_VERSION_C 6
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
#if ((ECUM_AR_RELEASE_MAJOR_VERSION_C != LINIF_AR_RELEASE_MAJOR_VERSION) || \
     (ECUM_AR_RELEASE_MINOR_VERSION_C != LINIF_AR_RELEASE_MINOR_VERSION) || \
     (ECUM_AR_RELEASE_REVISION_VERSION_C != LINIF_AR_RELEASE_REVISION_VERSION))
...
/*==================================================================================================
                                       GLOBAL VARIABLES
==================================================================================================*/
VAR(EcuM_WakeupSourceType, ECUM_VAR) EcuMLastWakeupEvent = 0xFFU; /**< @brief last wakeup event to EcuM (source ID)*/
