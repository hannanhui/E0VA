...
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_SingleBlockCallbackType)(
    ...
    NvM_RequestResultType JobResult); /* A pointer to single block callback function.*/
 ...
 *          E_NOT_OK:Callback function has not been processed successfully
 */
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_ReadRamBlockFromNvmCallbackType)(
    const void* NvMBuffer); /* A pointer to copy ram to ram mirror callback function.*/
 ...
 *          E_NOT_OK:Callback function has not been processed successfully
 */
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_WriteRamBlockToNvmCallbackType)(
    void* NvMBuffer); /* A pointer to copy ram to ram mirror callback function.*/
...
typedef P2FUNC(void, NVM_APPL_CODE, NvM_MultiBlockCallbackType)(
    ...
    NvM_RequestResultType JobResult); /* A pointer to multi block callback function.*/
...
{
    NvM_BlockIdType BlockId;
    P2VAR(uint8, TYPEDEF, NVM_APPL_DATA) DestSrcPtr;
} NvM_ImmedQueueType;
#endif
