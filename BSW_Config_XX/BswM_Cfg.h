...
**                      Global Functions                                      **
*******************************************************************************/
extern void Act_RequestRUNCallout(void);
extern void Act_ReleaseRUNCallout(void);
extern void Act_BSWMAPPPOstRUNRequest(void);
extern void Act_BSWMAPPPOstRUNRelease(void);
