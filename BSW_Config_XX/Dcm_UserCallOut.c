...
/**
 * @brief 	Internal buffer of the "DcmDspData_0xF103".
 */
extern VAR(uint8, DCM_VAR)Dcm_DspDataInternalBuffer_DcmDspData_0xF103[16];
...
)
{
    ...
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF180[u16Index];
    }
    return result;
}
...
)
{
    ...
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF187[u16Index];
    }
    return result;
}
...
)
{
    ...
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF189[u16Index];
    }
    return result;
}
...
)
{
    ...
    for(u16Index = 0u; u16Index < 24u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF089[u16Index];
    }
    return result;
}

FUNC(Std_ReturnType, DCM_CODE)DcmDspDataConditionCheckRead_0xF103
(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR)ErrorCode
)
...
FUNC(Std_ReturnType, DCM_CODE)DcmDspDataRead_0xF103
(
    Dcm_OpStatusType OpStatus,
    P2VAR(uint8, AUTOMATIC, DCM_VAR)Data,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR)ErrorCode
)
{
    ...
    for(u16Index = 0u; u16Index < 16u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF103[u16Index];
    }
    return result;
}
...
)
{
    ...
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF18A[u16Index];
    }
    return result;
}
...
)
{
    ...
    (void)ErrorCode;
    uint16 u16Index;
    for(u16Index = 0u; u16Index < 47u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF18C[u16Index];
    }
    return result;
}
...
)
{
    ...
    (void)ErrorCode;
    uint16 u16Index;
    for(u16Index = 0u; u16Index < 1u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF186[u16Index];
    }
    return result;
}
...
)
{
    ...
    (void)ErrorCode;
    uint16 u16Index;
    for(u16Index = 0u; u16Index < 18u; u16Index++)
    {
...
)
{
    ...
    for(u16Index = 0u; u16Index < 18u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF0F1[u16Index];
    }
    return result;
}
...
)
{
    ...
    for(u16Index = 0u; u16Index < 18u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF0F3[u16Index];
    }
    return result;
}
...
)
{
    ...
    for(u16Index = 0u; u16Index < 18u; u16Index++)
    {
        Data[u16Index] = Dcm_DspDataInternalBuffer_DcmDspData_0xF160[u16Index];
    }
    return result;
}
...
)
{
    ...
    for(u16Index = 0u; u16Index < 16u; u16Index++)
    {
        if(Dcm_LocalKey[u16Index] != Key[u16Index])
        {
...
)
{
    ...
    for(u16Index = 0u; u16Index < 16u; u16Index++)
    {
        Dcm_RandSeed[u16Index] = (uint8)(rand() % 256u);
        Seed[u16Index] = Dcm_RandSeed[u16Index];
    }
    uint8 u8XorMask = 0x5Au;
    for(u16Index = 0u; u16Index < 16u; u16Index++)
    {
        Dcm_LocalKey[u16Index] = Seed[u16Index] ^ u8XorMask;
    }
    return result;
}
