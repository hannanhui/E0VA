...
#define KEYM_SW_PATCH_VERSION            3U
...
typedef struct KeyM_Asn1Type
{
    uint32 tag;
    uint32 len;
    P2VAR(uint8, TYPEDEF, KEYM_VAR) dataEle;
...
typedef struct
{
    ...
    P2VAR(KeyM_Asn1DesType, TYPEDEF, KEYM_VAR) eleItrator;
...
typedef struct
{
    ...
    P2CONST(void, AUTOMATIC, KEYM_APPL_CONST) certData;
} KeyM_CertDataType;
/*******************************************************************************
