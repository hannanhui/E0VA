...
/**
 * @file      : Port_PBcfg.h
 * @brief     : AUTOSAR Port PB config file
 *              - Platform: Z20K14xM
...
#define PORT_PBCFG_H_VENDOR_ID                   0x00B3U
#define PORT_PBCFG_H_AR_RELEASE_MAJOR_VERSION    4U
#define PORT_PBCFG_H_AR_RELEASE_MINOR_VERSION    6U
#define PORT_PBCFG_H_AR_RELEASE_REVISION_VERSION 0U
#define PORT_PBCFG_H_SW_MAJOR_VERSION            2U
