...
#define MCALLIB_CFG_H_SW_MAJOR_VERSION            2U
#define MCALLIB_CFG_H_SW_MINOR_VERSION            0U
#define MCALLIB_CFG_H_SW_PATCH_VERSION            0U
...
/**
 * @brief Defines McalLib module id
*/
...
*/
#define MCALLIB_DEV_ERROR_DETECT                 (STD_OFF)
