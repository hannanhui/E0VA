...
#define PORT_DRVW_CFG_H_SW_MAJOR_VERSION            2U
#define PORT_DRVW_CFG_H_SW_MINOR_VERSION            0U
#define PORT_DRVW_CFG_H_SW_PATCH_VERSION            0U
...
#define PORT_DRVW_DEV_ERROR_DETECT           (STD_OFF)

#define PORT_DRVW_SET_PIN_DIRECTION_API      (STD_ON)

#define PORT_DRVW_SET_PIN_MODE_API           (STD_ON)

#define PORT_DRVW_NUMBER_OF_CONFIG_PINS     ((uint16)69)

#define PORT_DRVW_MAX_PINMUX_NUMBER         ((uint8)8)

#define PORT_DRVW_NUMBER_OF_UNCONFIG_PINS   (17U)
