...
#define WDG_CFG_H_SW_MAJOR_VERSION            2U
#define WDG_CFG_H_SW_MINOR_VERSION            0U
#define WDG_CFG_H_SW_PATCH_VERSION            0U
...
/**
* @brief  Defines the watchdog initial timeout value
*/
#define WDG_INITIAL_TIMEOUT        ((uint32)1000)
