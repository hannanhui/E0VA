...
#define WDG_DRVW_CFG_H_SW_MAJOR_VERSION            2U
#define WDG_DRVW_CFG_H_SW_MINOR_VERSION            0U
#define WDG_DRVW_CFG_H_SW_PATCH_VERSION            0U
...
*/
#define WDG_DRVW_DIRECT_SERVICE        (STD_OFF)
