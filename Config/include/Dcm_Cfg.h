...
#define DCM_UDS0x14_ENABLE                                  STD_OFF
#define DCM_UDS0x19_ENABLE                                  STD_OFF
...
#define DCM_UDS0x34_ENABLE                                  STD_ON
#define DCM_UDS0x35_ENABLE                                  STD_OFF
#define DCM_UDS0x36_ENABLE                                  STD_ON
#define DCM_UDS0x37_ENABLE                                  STD_ON
...
#define DCM_UDS0x34_INTERNAL_FNC_ENABLE                     STD_ON
#define DCM_UDS0x36_INTERNAL_FNC_ENABLE                     STD_ON
#define DCM_UDS0x37_INTERNAL_FNC_ENABLE                     STD_ON
...
#define DCM_DSL_PROTOCOL_RX_NUM                             2u
#define DCM_DSL_PROTOCOL_TX_NUM                             1u
#define DCM_DSL_PERIODIC_CONNECTION_NUM                     0u
#define DcmConf_DcmDslProtocolRx_LinPdu_LinTpToDcm_MasterReq_Rx                      0u
#define DcmConf_DcmDslProtocolRx_LinTp_To_PudR_Function_Rx                      1u
#define DcmConf_DcmDslProtocolTx_LinPdu_DcmToLinTp_SlaveResp_Tx                      0u
...
#define DCM_DSP_COMMON_AUTHORIZATION_NUM                    1u
#define DCM_DSP_COM_CONTROL_ALL_CHANNEL_NUM                 1u
#define DCM_DSP_COM_CONTROL_SPECIFIC_CHANNEL_NUM            0u
#define DCM_DSP_COM_CONTROL_SUB_NODE_NUM                    0u
#define DCM_DSP_DATA_NUM                                    9u
#define DCM_DSP_DATA_BLOCK_USED_NUM                         0u
#define DCM_DSP_DID_NUM                                     9u
#define DCM_DSP_DDDID_NUM                                   0u
#define DCM_DSP_DID_SIGNAL_NUM                              9u
#define DCM_DSP_DID_INTO_NUM                                9u
#define DCM_DSP_DDDID_ELEMENT_MAX_NUM                       0u
#define DCM_DSP_DID_DATA_MAX_SIZE                           32u
#define DCM_DSP_DID_RANGE_NUM                               0u
#define DCM_DSP_MEMORY_NUM                                  1u
#define DCM_DSP_MEMORY_FORMAT_ID_NUM                        0u
#define DCM_DSP_MEMORY_ID_INFO_NUM                          2u
#define DCM_DSP_READ_MEMORY_RANGE_INFO_NUM                  2u
#define DCM_DSP_WRITE_MEMORY_RANGE_INFO_NUM                 2u
...
#define DCM_DSP_ROUTINE_NUM                                 5u
#define DCM_DSP_REQUEST_ROUTINE_RESULTS_IN_SIGNAL_NUM       0u
#define DCM_DSP_REQUEST_ROUTINE_RESULTS_OUT_SIGNAL_NUM      0u
#define DCM_DSP_START_ROUTINE_IN_SIGNAL_NUM                 2u
#define DCM_DSP_START_ROUTINE_OUT_SIGNAL_NUM                5u
...
#define DCM_DSP_DATA_WRITE_FNC_ENABLED                      STD_ON
