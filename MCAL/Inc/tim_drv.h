...
typedef enum
{
    TIM_CLK_SOURCE_SYSTEM   = 1U,     /*!< Core Clock as TIM Counter Clock*/
...
typedef enum
{
    TIM_POL_HIGH = 0U,                /*!< TIM channel output polarity is high:
                                          Logic 0 is inactive state;
                                          Logic 1 is active state;            */
    TIM_POL_LOW                       /*!< TIM channel output polarity is low:
...
typedef enum
{
    TIM_PRESCALER_1 = 1U,            /*!< divided the core clock by 1*/
    TIM_PRESCALER_4,                 /*!< divided the core clock by 4*/
    TIM_PRESCALER_16                 /*!< divided the core clock by 16*/
...
typedef struct
{
    ...
    ControlState_t complementaryEnable; /*!< Complementary mode cmd: ENABLE/DISABLE */
