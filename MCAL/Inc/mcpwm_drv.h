...
typedef enum
{
    ...
    MCPWM_CLK_SOURCE_SYSTEM   = 1U,     /*!< core clock as MCPWM Counter Clock*/
...
typedef enum
{
    MCPWM_UPDATE_SYSTEM_CLK = 0U,     /*!< update on all rising edge of the core clock*/
...
typedef struct
{
    ...
    MCPWM_PwmChannelConfig_t * MainPwmChConfig;  /*!< independent pwm config for main channel */
    MCPWM_PwmChannelConfig_t * SecondPwmChConfig;/*!< independent pwm config for second channel */
} MCPWM_PwmConfig_t;
